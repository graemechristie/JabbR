...
{
    /// <summary>
    /// This has temporarily been migrated into the test project to allow the unit tests for the existing commands
    /// Utilising CommandManager to run without being modified.
    /// Will be depreciated when the tests are rewitten.
    /// </summary>
    public class CommandManager
    {
        ...
        {
            var catalog = new AssemblyCatalog(Assembly.GetAssembly(typeof(ICommand)));
